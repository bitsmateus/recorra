...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Etiquetas do cliente são as mesmas criadas em Clientes > Etiquetas — ligar/desligar na linha do tempo (ou no card da Esteira) não cria uma etiqueta nova, só marca/desmarca o cliente numa já existente.',
      'Responsável é o operador atribuído ao cliente (definido na linha do tempo) — usado só como filtro "por pessoa" na Esteira, não restringe quem pode ver ou mexer no cliente.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Refine por situação (Todas, Vencidas, A vencer), canal, carteira (quando o tenant tem mais de uma) e responsável (operador atribuído ao cliente).',
      ...
      'Clique no ícone de linha do tempo do card para abrir uma versão maior, com notas, promessas e disparos do cliente, marcar etiquetas (do catálogo criado em Clientes > Etiquetas) e definir o responsável — sem abrir o cadastro completo.',
    ],
    rules: [
      ...
      'Responsável é uma atribuição manual (definida na linha do tempo do cliente ou no perfil), independente da carteira — não restringe quem vê o cliente, só ajuda a filtrar "por pessoa" na esteira.',
    ...
    keywords: ['esteira', 'andamento', 'kanban', 'etapa', 'quadro', 'lote', 'reenviar', 'retido', 'rescisão', 'serasa', 'carteira', 'equipe', 'pessoa', 'responsável', 'nota', 'promessa', 'linha do tempo', 'disparar com', 'etiqueta'],
  },
  {
